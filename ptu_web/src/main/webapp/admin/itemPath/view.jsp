...
//            response.setDateHeader("Expire", 0);
        ...
        %>
            ...
            <a class="btn btn-outline-primary" href="<%=Constants.ADMIN_ITEM%>">Back</a>&nbsp;&nbsp;&nbsp;&nbsp;
            <a class="btn btn-outline-success" href="<%=Constants.ADMIN_ITEM_EDIT%>/${not empty item ? item.getId() : ""}">Edit</a>
            <br><br>
            ...
            <br><br><a href="<%=Constants.ADMIN_ITEM_DELETE%>/${not empty item ? item.getId() : ""}" onclick="if(confirm('Are you sure?')){return true;}else{return false;}" class="btn btn-outline-danger">Delete!</a>
        <%}%>
